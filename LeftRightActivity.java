...
import com.jonny.myexamplepac.Adapter.NavigationAdapter;
import com.jonny.myexamplepac.bean.NavigationItemBean;
import com.jonny.myexamplepac.tools.AppToast;
import com.jonny.myexamplepac.view.CustomViewPager;
import com.jonny.myexamplepac.view.SwipeFlingAdapterView;
...
public class LeftRightActivity extends AppCompatActivity implements SwipeFlingAdapterView.onFlingListener,
    ...
    private class InnerAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.cityView.setCompoundDrawablesWithIntrinsicBounds(0,R.mipmap.home01_icon_location,0,0);

            holder.eduView.setHint(no);
            holder.eduView.setText(talent.educationName);
            holder.eduView.setCompoundDrawablesWithIntrinsicBounds(0,R.mipmap.home01_icon_edu,0,0);

            holder.workView.setHint(no);
            holder.workView.setText(talent.workYearName);
            holder.workView.setCompoundDrawablesWithIntrinsicBounds(0,R.mipmap.home01_icon_work_year,0,0);
