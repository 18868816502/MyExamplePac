...
public class ElemaViewPagerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elema_viewpage);
    ...
    private void initDot() {
        for (int i = 0; i < (itemBeanList.size() / 9 + 1); i++) {
            ...
            dots.add(imageView);
            //由于刚进去引导页时出现的是第一个引导页，故此时的导航点设置为绿色
            if (i == 0) {
